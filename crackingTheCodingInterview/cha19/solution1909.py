...
each tag gets mapped to a pre-defined integer value. The
...
as string).
FOLLOW UP
Is there anything else you could do to (in many cases) compress this
even further?
"""

def encode_xml(strxml):
    """

    i think the grammar is not fully defined
    """
    pass
